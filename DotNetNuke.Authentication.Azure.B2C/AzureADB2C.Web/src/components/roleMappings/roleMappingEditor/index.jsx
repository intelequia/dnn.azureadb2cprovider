            ...
            const columnTwo = <div key="column-two" className="right-column">
                <InputGroup>
                    <SingleLineInputWithError
                        withLabel={true}
                        label={resx.get("lblB2cRoleName")}
                        tooltipMessage={resx.get("lblB2cRoleName.Help")}
                        inputStyle={{ margin: "0" }}
                        error={this.state.error.b2cRoleName}
                        errorMessage={resx.get("InvalidB2cRoleName")}
                        value={this.state.mappingDetail.B2cRoleName}
                        onChange={this.onSettingChange.bind(this, "B2cRoleName")}
                    />
                </InputGroup>
            </div>;
